...
class MNISTModel(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.operation_rep = nn.Sequential(nn.Linear(6, 64),
                                            nn.ReLU(),
    ...
    def forward(self, x, h_prev, inp_transforms, rule_mask = None):
        ...
        #print('x in forward after encoder : ', len(encoded_input))
        #print('x image in forward after encoder : ', encoded_input[0].shape)
        # print('inp_transforms.shape:', inp_transforms.shape)
