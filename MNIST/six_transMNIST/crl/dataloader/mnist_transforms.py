...
class BasicTransformDataset(torch.utils.data.Dataset):
    def __init__(self, inputs, targets, num_transforms = 8, transform_length = 3, gen = True, state = "Train"):
        ...
        self.transforms = {#'horizontal_flip': lambda q: torch.flip(q, dims=(2,)),
                   #'vertical_flip': lambda q: torch.flip(q, dims=(1,)),
                   'translate_left': Translate(0, 0.3)(),
                   'translate_right': Translate(0, -0.3)(),
                   'translate_up':Translate(0.3, 0)(),
                   'translate_down':Translate(-0.3, 0)(),
    ...
    def __getitem__(self, bsize):   # bsize = random image
        ...
        #print('inputs shape in getitem: ', inputs.shape)
        ...
        #print('images shape in getitem: ', images[0].shape)
        #print('bsize= ', bsize)
        
        base_image = place_subimage_in_background((64, 64))(inputs)
        ...
        for t in range(self.transform_length):
            ...
            im_ = images[-1]
            # print("Dimensions of im_:", im_.shape)
